...
void link::insert_record(){
    ...
    GetSystemTime(&x);
    file.open("kimleang.txt",ios::app|ios::out);
    file<<e_id<<" "<<e_pass<<" "<<e_pin<<" "<<e_name<<" "<<e_fname<<" "<<e_address<<" "<<e_phone<<" "<<e_balance<<" "<<e_balanceriel<<"\n";
    file.close();
...
void link::edit_record(){
    ...
    if(head == NULL){
        ...
        cin>>t_id;
        file.open("kimleang.txt",ios::in);
        file1.open("kimleang1.txt",ios::app|ios::out);
        ...
        file1.close();
        remove("kimleang.txt");
        rename("kimleang1.txt","kimleang.txt");
        if(found == 0){
...
void pay::information(){
    ...
    file.open("panha.txt",ios::app|ios::out);
...
void pay::update(){
    ...
    if(head == NULL){
        ...
        cin>>t_id;
        file.open("panha.txt",ios::in);
        file1.open("panha1.txt",ios::app|ios::out);
